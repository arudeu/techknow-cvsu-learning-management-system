...
function editUserStatus($conn)
{
    if(isset($_POST['editUserStat']))
    {
        $id = $_POST['editUserStat'];
        $editstatsql = "UPDATE users SET statusUsers = 'Pending' WHERE idUsers = '$id'";
        $editstatres = $conn->query($editstatsql);
...
function approveUserApplication($conn)
{
